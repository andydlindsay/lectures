...
const { keyMatcher } = require("../test-2/01");

describe.skip('keyMatcher', () => {
  ...
  it('returns false when key doesn\'t exist in both \n { name: "Larry", wings: 2 } and \n { name: "Daffy", wings: "2" }', () => {
    let result = keyMatcher({name: "Larry", wings: 2}, {name: "Daffy", wings: "2"}, "issues");
